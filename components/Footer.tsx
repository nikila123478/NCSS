...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-white text-gray-900 border-t border-gray-200 pt-16 pb-8 relative z-40">
          ...
          <div className="flex gap-3 flex-wrap">
            {footerData.socialLinks.map(link => (
              <a
                ...
                className="p-2 bg-gray-100 rounded-lg hover:bg-red-600 hover:text-white transition-all flex items-center gap-2 text-xs font-bold"
              >
        ...
        <div>
          ...
          <form className="space-y-3" onSubmit={handleSendMessage}>
            <input
              ...
              className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-red-600 transition-colors"
            />
            <textarea
              placeholder="Message"
              rows={2}
            ...
            <button
              type="submit"
              disabled={sending}
              className={`w-full py-2 bg-black text-white font-bold rounded-lg hover:bg-red-600 transition-colors flex justify-center items-center gap-2 ${sending ? 'opacity-50' : ''}`}
            >
      ...
      <div className="mt-16 pt-8 border-t border-gray-100 text-center text-gray-400 text-xs font-medium uppercase tracking-wider">
